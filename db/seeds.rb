...
User.all.each do |user|
    ...
    {
      title: "下書き投稿",
      body: "本文は下書き投稿です。２００文字以内で投稿可能です。テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト",
      tag: "下書きタグ",
      is_draft: true # 下書きを示す状態を追加
    },
    {
      title: "夏場のエアコン（下書き）",
      body: "夏場のエアコンは、こまめに切るよりつけっぱなしにしていたほうが電気代がかからない。日中9:00～18:00の時間帯は、30分間であればエアコンを切るより、「つけっぱなし」にするほうが消費電力量は少なかった。",
